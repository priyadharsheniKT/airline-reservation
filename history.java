...
class test5 
{
	...
	l2=new JLabel("YOUR BOOKING HISTORY");
	

	f.add(l2);
        l2.setBounds(630,10,500,100);
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
                try (Connection con = DriverManager.getConnection(url,username,pass)) 
                {
                    ...
                    if (res.next())
                    {
                        ...
                        //System.out.println("Passport ID: " + pID);
                        String sql2 = "SELECT * FROM history WHERE Name = ? AND Passport_ID = ?";
                        ...
                        if (res.next())
                        {
                            ...
                            System.out.println("Booking History Found");
                        }
                        else
                        {
